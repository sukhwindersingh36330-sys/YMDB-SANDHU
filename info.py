...
PICS = (environ.get('PICS', 'https://i.ibb.co/9mDYsVzc/photo-2025-06-29-08-14-56-7521281887633932296.jpg')).split() #random anime girl img each time from aniwallpaper (Experimental)
...
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '-1002122152204').split()] #(make sure bot is admin)
